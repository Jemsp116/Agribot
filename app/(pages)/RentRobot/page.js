  ...
  const robotsAndDrones = [
    {
      ...
      terms:
        "Usage requires proper training and adherence to safety guidelines.",
    },
    {
      name: "DroneTech Y2",
      type: "Drone",
      ...
      terms:
        "All flights must be conducted within legal boundaries and with necessary permits.",
    },
    {
      name: "AgriBot Z3",
      type: "Robot",
      ...
      pricePoint:
        "Pricing is based on the size of the field and specific harvesting needs.",
    ...
    },
    {
      ...
      pricePoint:
        "Flexible pricing options available for various data analysis packages.",
      rentPrice: "Rent for $400 per day",
      terms:
        "Drone usage must comply with local aviation regulations and data privacy laws.",
    },
    {
      name: "AgriBot Y4",
      type: "Robot",
      ...
      pricePoint:
        "Rates depend on the extent of soil preparation and robot features.",
      rentPrice: "Rent for $600 per day",
      terms:
        "Proper calibration and usage training are mandatory for effective operation.",
    },
    {
